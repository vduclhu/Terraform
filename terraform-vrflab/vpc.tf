...
resource "aws_route_table_association" "us-west-2a-public3" {
    provider = "aws.oregon"
    subnet_id = "${aws_subnet.us-west-2a-public3.id}"
    route_table_id = "${aws_route_table.us-west-2a-public.id}"
}
...
resource "aws_subnet" "us-east-2a-public4" {
    provider = "aws.ohio"
    vpc_id = "${aws_vpc.cosmos-vrouter-corerouter-region2-vpc.id}"

    cidr_block = "${var.public_subnet4_cidr_region2}"
    availability_zone = "us-east-2a"
...
resource "aws_route_table_association" "us-east-2a-public4" {
    provider = "aws.ohio"
    subnet_id = "${aws_subnet.us-east-2a-public4.id}"
    route_table_id = "${aws_route_table.us-east-2a-public.id}"
}